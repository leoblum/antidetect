...
const { init, blankId, invalidId } = require('./common')

describe('profiles', function () {
  let api = null
  beforeEach(async function () {
    api = await init()
    await api.mock.userAndAuth()
  })
  ...
  it('should create profile', async function () {
    ...
    const fingerprint = await api.mock.fingerprint('mac')
  ...
  it('should update by id', async function () {
    ...
    const profile = await api.mock.profile({ name: '1234', os: 'mac' })
  ...
  it('should delete by id', async function () {
    let rep = null
    const profileId = (await api.mock.profile({}))._id
  ...
  it('should delete by id (bulk)', async function () {
    ...
    const id1 = (await api.mock.profile({}))._id
    const id2 = (await api.mock.profile({}))._id
